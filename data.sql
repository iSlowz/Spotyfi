...
INSERT INTO public.style(style) VALUES('pop');
INSERT INTO public.style(style) VALUES('rock');
INSERT INTO public.style(style) VALUES('funk');
INSERT INTO public.style(style) VALUES('rap');
...
INSERT INTO public.album(title_album, photo_album, date_creation_album, id_artiste, id_style) VALUES('first_album', '../album_cover/album1.png', DATE '2022-08-08', (SELECT id_artiste FROM public.artiste WHERE nom_artiste = 'M'), 1);
INSERT INTO public.album(title_album, photo_album, date_creation_album, id_artiste, id_style) VALUES('second_album', '../album_cover/album2.png', DATE '2023-08-08', (SELECT id_artiste FROM public.artiste WHERE nom_artiste = 'M'), (SELECT id_style FROM public.style WHERE style = 'rock'));
