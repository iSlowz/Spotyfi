...
INSERT INTO public.musique(titre_musique, lien_musique, duree_musique, date_parution_musique, id_artiste, id_album, id_style) VALUES('music3', '../musique/ukulele-trip.mp3', TIME '00:01:00', DATE '2023-08-08', (SELECT id_artiste FROM public.artiste WHERE pseudo_artiste = 'M'), (SELECT id_album FROM public.album WHERE titre_album = 'second_album'), (SELECT id_style FROM public.album WHERE titre_album = 'second_album'));
