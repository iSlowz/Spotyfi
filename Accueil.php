  ...
  <div class="disposition">   
    ...
    <div class="Navbar-Recherche">
      ...
      <div class="bouton-user">
        <button class="btn" id="id-bouton-user" type="button"> Profil
    ...
    <div class="Bar-Footer">
      <div class="d-flex flex-footer">
        <div class="footer-detail-musique">
        <img src="/album_cover/album1.png">
        </div>
          ...
          <div class="flex-footer-bouton">
            <div class="flex-footer-bouton-menu">
              <div class="bouton-footer" id="musique-player"> 
                ...
                <button class="bouton-menu-footer" id="btn-skip-gauche" onClick="setCurrentTime(0)">
                ...
                <button class="bouton-menu-footer" id="btn-skip-droit">
